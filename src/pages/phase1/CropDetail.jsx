...
const cropData = {
    wheat: {
        nameKey: "cropGehun", nameEn: "Wheat", price: "₹2,150", msp: "₹2,015",
        img: "/images/wheat.png", rating: 4.9, reviews: 192,
        descHi: "गेहूँ भारत की सबसे महत्वपूर्ण रबी फसल है। इसकी बुवाई अक्टूबर-नवंबर में की जाती है और कटाई मार्च-अप्रैल में होती है। उत्तर प्रदेश, पंजाब, हरियाणा, मध्य प्रदेश और राजस्थान गेहूँ के प्रमुख उत्पादक राज्य हैं।",
        descEn: "Wheat is India's most important Rabi crop. It is sown in October-November and harvested in March-April. Uttar Pradesh, Punjab, Haryana, Madhya Pradesh and Rajasthan are major wheat-producing states.",
        related: ["/images/rice.png", "/images/mustard.png", "/images/sugarcane.png", "/images/vegetables.png"],
    },
    rice: {
        nameKey: "cropDhan", nameEn: "Rice", price: "₹1,890", msp: "₹2,183",
        img: "/images/rice.png", rating: 4.7, reviews: 156,
        descHi: "धान भारत की प्रमुख खरीफ फसल है। इसकी रोपाई जून-जुलाई में की जाती है। पश्चिम बंगाल, उत्तर प्रदेश, पंजाब और तमिलनाडु प्रमुख उत्पादक राज्य हैं।",
        descEn: "Rice is India's main Kharif crop. It is transplanted in June-July. West Bengal, Uttar Pradesh, Punjab and Tamil Nadu are major producing states.",
        related: ["/images/wheat.png", "/images/mustard.png", "/images/sugarcane.png", "/images/vegetables.png"],
    },
    mustard: {
        nameKey: "cropSarson", nameEn: "Mustard", price: "₹5,400", msp: "₹5,650",
        img: "/images/mustard.png", rating: 4.6, reviews: 88,
        descHi: "सरसों रबी सीजन की प्रमुख तिलहन फसल है। राजस्थान, मध्य प्रदेश, उत्तर प्रदेश और हरियाणा प्रमुख उत्पादक राज्य हैं।",
        descEn: "Mustard is the main oilseed crop of the Rabi season. Rajasthan, Madhya Pradesh, Uttar Pradesh and Haryana are major producing states.",
        related: ["/images/wheat.png", "/images/rice.png", "/images/sugarcane.png", "/images/vegetables.png"],
    },
    sugarcane: {
        nameKey: "cropGanna", nameEn: "Sugarcane", price: "₹350", msp: "₹315",
        img: "/images/sugarcane.png", rating: 4.5, reviews: 74,
        descHi: "गन्ना भारत की प्रमुख नकदी फसल है। उत्तर प्रदेश, महाराष्ट्र और कर्नाटक प्रमुख उत्पादक राज्य हैं।",
        descEn: "Sugarcane is India's major cash crop. Uttar Pradesh, Maharashtra and Karnataka are major producing states.",
...
export default function CropDetail() {
    ...
    return (
        <div className="pb-[100px] bg-white min-h-screen">
            <PageHeader title={t("cropDetailTitle")} />
            ...
            <motion.div variants={fadeUp} initial="hidden" animate="visible" className="px-5">
                ...
                <div className="farmiq-card p-4 mb-4">
                    <h2 className="text-[20px] font-bold text-[#1A1A1A]" style={{ fontFamily: font }}>{cropName}</h2>
                    <div className="flex items-center justify-between mt-2">
                        <span className="text-[13px] text-[#2E7D32] font-medium" style={{ fontFamily: font }}>{t("available")}</span>
                        <span className="text-[18px] font-bold text-[#1A1A1A]" style={{ fontFamily: "var(--font-english)" }}>{crop.price}{t("perQuintal")}</span>
                    </div>
                ...
                <div className="farmiq-card p-4 mb-4">
                    <h3 className="text-[16px] font-bold text-[#1A1A1A] mb-3" style={{ fontFamily: font }}>
                        {t("pestDiagnosis")}
                    </h3>
                    <input
                        type="file"
                    ...
                    {pestLoading && (
                        <div className="flex items-center justify-center gap-2 mt-3 py-3">
                            ...
                            <span className="text-[14px] text-[#666]" style={{ fontFamily: font }}>{t("diagnosing")}</span>
                        </div>
                    )}

                    {pestError && (
                        <div className="mt-3 px-3 py-2 rounded-[10px] bg-red-50 text-red-700 text-[13px]" style={{ fontFamily: font }}>
                            {pestError}
                        </div>
                    )}
                    ...
                    <AnimatePresence>
                        {pestResult && (
                            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mt-3 p-4 rounded-[12px] bg-[#F0F7F2]">
                                <p className="text-[14px] text-[#1A1A1A] leading-[1.8] whitespace-pre-wrap" style={{ fontFamily: font }}>
                                    {pestResult}
                                </p>
                                <button
                                    onClick={() => sharePestDiagnosis(cropName, pestResult)}
                ...
                {/* Info */}
                <div className="mb-4">
                    <h3 className="text-[16px] font-bold text-[#1A1A1A] mb-2" style={{ fontFamily: font }}>{t("info")}</h3>
                    <p className="text-[14px] text-[#666] leading-[1.7]" style={{ fontFamily: font }}>
                        {isEn ? crop.descEn : crop.descHi}
                        <button className="text-[#1B5E3B] font-semibold ml-1">{t("readMore")}</button>
                    </p>
                </div>

                {/* Also see */}
                <div className="mb-4">
                    <h3 className="text-[16px] font-bold text-[#1A1A1A] mb-3" style={{ fontFamily: font }}>{t("alsoSee")}</h3>
            ...
            <div className="fixed bottom-[80px] left-1/2 -translate-x-1/2 w-full max-w-[430px] px-5 z-40">
                <button onClick={() => navigate("/home")} className="w-full h-[56px] rounded-[16px] bg-[#1B5E3B] text-white font-bold text-[16px] active:scale-[0.98] transition-transform shadow-lg" style={{ fontFamily: font }}>
                    {t("addToCrops")}
                </button>
            </div>
        </div>
